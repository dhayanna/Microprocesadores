...
{  
  ...
  else if(digitalRead(PB_DOWN) && !estado_anterior_down && led > 0)
  {
    led--;
  ...
  case 0:
    ...
    break;
  case 1:
    out[5]=0; out[4]=1; out[3]=0; out[2]=0; out[1]=0; out[0]=0;
    break;
  case 2:
    out[5]=0; out[4]=0; out[3]=1; out[2]=0; out[1]=0; out[0]=0;
    break;
  case 3:
    out[5]=0; out[4]=0; out[3]=0; out[2]=1; out[1]=0; out[0]=0;
    break;
  case 4:
    out[5]=0; out[4]=0; out[3]=0; out[2]=0; out[1]=1; out[0]=0;
    break;
  case 5:
    out[5]=0; out[4]=0; out[3]=0; out[2]=0; out[1]=0; out[0]=1;
    break;
  }
